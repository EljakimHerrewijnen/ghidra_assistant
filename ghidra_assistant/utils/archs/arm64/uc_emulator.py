...
from .asm_arm64 import ShellcodeCrafterARM64
from ...utils import *
...
class ARM64UC_Emulator():
    ...
    def write_ptr32(self, at, ptr):
        return self.write_memory(at, p32(ptr))

    def write_ptr64(self, at, ptr):
        return self.write_memory(at, p64(ptr))

    def read_ptr32(self, at):
        return u32(self.read_memory(at, 4))

    def read_ptr64(self, at):
        return u64(self.read_memory(at, 8))
    ...
    def write_memory(self, address, data):
        return self.uc.mem_write(address, data)
    ...
    def print_ctx(self, print_f = p_info):
